...
if authentication_status:
    ...
    page = st.sidebar.selectbox("探索或预测", ("email_addresses",
        "image_to_text"
        ))

    if page == "email_addresses":

        st.title("从域名获取电子邮件地址")
        st.write("Rapid API[link](https://rapidapi.com/letscrape-6bRBa3QguO5/api/website-contacts-scraper)")
